...
const copyEn = {
  ...
  script: {
    ...
    subtitle: "Paste your product details, pick a style, and let AI write compelling copy for TikTok Shop, Shopee, and beyond."
  },
  form: {
    ...
    imageCounter: (count) => `${count}/4 images`,
    imageDropEmpty: "Drop images or click to upload",
    imageDropFilled: "Replace or add images",
    imageHint: "Clear product photos help AI write more naturally and accurately. Max 4 images, 8MB per file.",
    autoSuggestOptions: "Auto Suggest Options",
    analyzing: "Analyzing...",
    confidenceLabel: "Confidence",
    addImageShort: "Add image",
    productName: "Product Name",
    productNamePlaceholder: "Example: Lace collar blouse and A-line skirt set",
    category: "Category",
    ...
    highlightsHelper: (count) => `One highlight per line (${count}/8)`,
    priceSegment: "Price Segment",
    priceSegmentPlaceholder: "Example: 329k / mid-high segment",
    attributes: "Additional Attributes",
    attributesHelper: (count) => `One attribute per line (${count}/10)`,
    usage: "How to Use",
  ...
  output: {
    ...
    variant: "Variant",
    loading: "AI is generating product intro content...",
    empty: "Fill product info and click Generate Content to see AI output.",
    ...
    moodLabel: "Mood",
    sourceFallbackHint: "Fallback mode: style/mood effect can be reduced when AI is unavailable.",
    copy: "Copy",
    download: "Download"
  },
  history: {
...
const copyVi = {
  ...
  script: {
    eyebrow: "SellerScript",
    title: "Biến thông tin sản phẩm thành nội dung bán hàng — chỉ trong vài giây.",
    subtitle: "Nhập thông tin sản phẩm, chọn phong cách, để AI viết nội dung chuẩn sàn TikTok Shop, Shopee cho bạn."
  },
  form: {
    ...
    imageCounter: (count) => `${count}/4 ảnh`,
    imageDropEmpty: "Kéo thả ảnh hoặc bấm để tải lên",
    imageDropFilled: "Thay đổi hoặc thêm ảnh",
    imageHint: "Ảnh rõ sản phẩm giúp AI viết tự nhiên và đúng ngữ cảnh hơn. Tối đa 4 ảnh, 8MB mỗi file.",
    autoSuggestOptions: "Gợi ý tự động",
    analyzing: "Đang phân tích...",
    confidenceLabel: "Độ tin cậy",
    addImageShort: "Thêm ảnh",
    productName: "Tên sản phẩm",
    productNamePlaceholder: "Ví dụ: Set áo cổ sen phối ren và chân váy chữ A",
    ...
    highlightsHelper: (count) => `Tách mỗi highlight trên 1 dòng (${count}/8)`,
    priceSegment: "Phân khúc giá",
    priceSegmentPlaceholder: "Ví dụ: 329k / phân khúc trung cao",
    attributes: "Thuộc tính bổ sung",
    attributesHelper: (count) => `Mỗi dòng là một thuộc tính (${count}/10)`,
    usage: "Cách dùng",
  ...
  output: {
    ...
    variant: "Biến thể",
    loading: "AI đang tạo nội dung giới thiệu sản phẩm...",
    ...
    moodLabel: "Mood",
    sourceFallbackHint: "Đang dùng fallback: hiệu ứng phong cách/mood có thể giảm khi AI chưa sẵn sàng.",
    copy: "Copy",
    download: "Tải về"
  },
  history: {
...
const copyZh = {
  ...
  script: {
    ...
    subtitle: "填写商品信息，选择风格，让 AI 为你生成适合TikTok、淘宝、拼多多的专业文案。"
  },
  form: {
    ...copyEn.form,
    panelTitle: "商品信息",
    ...
    reset: "重置",
    imageSet: "商品图片",
    imageCounter: (count) => `${count}/4 张图片`,
...
const copyJa = {
  ...
  script: {
    ...
    subtitle: "商品情報を入力してスタイルを選ぶだけ。AIがTikTok・楽天・Amazonに対応した魅力的な文章を生成します。"
  },
  form: {
    ...copyEn.form,
    panelTitle: "商品入力",
...
const copyKo = {
  ...
  script: {
    ...
    subtitle: "상품 정보를 입력하고 스타일을 선택하면 AI가 TikTok·쿠팡·스마트스토어에 최적화된 문구를 작성해 드립니다."
  },
  form: {
    ...copyEn.form,
    panelTitle: "상품 입력",
    ...
    reset: "초기화",
    imageSet: "상품 이미지",
    imageCounter: (count) => `${count}/4 이미지`,
...
const copyEs = {
  ...
  script: {
    ...
    subtitle: "Pega los datos del producto, elige el estilo y deja que la IA escriba el copy perfecto para TikTok Shop y más."
  },
  form: {
    ...copyEn.form,
...
const copyFr = {
  ...
  script: {
    ...
    subtitle: "Saisissez les détails, choisissez le style, et laissez l'IA rédiger des textes percutants pour TikTok Shop, Amazon et plus."
  },
  form: {
    ...copyEn.form,
...
const copyDe = {
  ...
  script: {
    ...
    subtitle: "Produktdaten eingeben, Stil wählen – die KI schreibt überzeugende Texte für TikTok Shop, Amazon und mehr."
  },
  form: {
    ...copyEn.form,
